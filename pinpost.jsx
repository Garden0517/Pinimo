            ...
            <div className="pinpost-bg" style={{backgroundImage: `url(${Bg})`}}>
                <div className="bg-black">
                    <div className="pinpost-top">
                        ...
                        <div className="profileEdit"><img src= {Edit} style={{width: "12px", height: "12px", marginRight: "6px"}}/>피드 편집</div>
                    </div>
